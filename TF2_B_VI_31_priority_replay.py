"""
A simple version of Prioritized Experience Replay based on Double DQN.
To play CartPole-v0.
...
class PERAgent:  # Double DQN with Proportional Prioritization
    def __init__(self, model, target_model, env, learning_rate=.001, epsilon=.1, epsilon_dacay=0.995, min_epsilon=.01,
                 gamma=.9, batch_size=8, target_update_iter=200, train_nums=1000, buffer_size=300, replay_period=20,
